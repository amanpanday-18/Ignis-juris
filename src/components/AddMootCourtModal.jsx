        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4 overflow-y-auto">
            ...
            >
                <div className="flex justify-between items-center p-6 border-b border-gray-100">
                    <h2 className="text-xl font-bold text-primary">Add Moot Court Competition</h2>
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4 max-h-[70vh] overflow-y-auto">
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Official Website / Registration Link</label>
                        <input
                            type="url"
                            name="officialLink"
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Image URL (Optional Banner)</label>
                        <input
                            type="url"
                            name="imageUrl"
